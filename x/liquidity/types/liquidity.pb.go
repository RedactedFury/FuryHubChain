...
type Order struct {
	...
	Type OrderType `protobuf:"varint,1,opt,name=type,proto3,enum=fury.liquidity.v1beta1.OrderType" json:"type,omitempty"`
	...
	Direction OrderDirection `protobuf:"varint,6,opt,name=direction,proto3,enum=fury.liquidity.v1beta1.OrderDirection" json:"direction,omitempty"`
	...
	Status   OrderStatus `protobuf:"varint,15,opt,name=status,proto3,enum=fury.liquidity.v1beta1.OrderStatus" json:"status,omitempty"`
}
...
func init() {
	proto.RegisterEnum("fury.liquidity.v1beta1.PoolType", PoolType_name, PoolType_value)
	proto.RegisterEnum("fury.liquidity.v1beta1.OrderType", OrderType_name, OrderType_value)
	...
	proto.RegisterType((*MMOrderIndex)(nil), "fury.liquidity.v1beta1.MMOrderIndex")
}

func init() {
	proto.RegisterFile("fury/liquidity/v1beta1/liquidity.proto", fileDescriptor_c9be4f53a63dce2f)
}
