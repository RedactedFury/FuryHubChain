...
type PoolResponse struct {
	Type                  PoolType                                `protobuf:"varint,1,opt,name=type,proto3,enum=fury.liquidity.v1beta1.PoolType" json:"type,omitempty"`
	Id                    uint64                                  `protobuf:"varint,2,opt,name=id,proto3" json:"id,omitempty"`
...
func init() {
	...
	proto.RegisterType((*QueryOrderBooksRequest)(nil), "fury.liquidity.v1beta1.QueryOrderBooksRequest")
	proto.RegisterType((*QueryOrderBooksResponse)(nil), "fury.liquidity.v1beta1.QueryOrderBooksResponse")
	proto.RegisterType((*PoolResponse)(nil), "fury.liquidity.v1beta1.PoolResponse")
	proto.RegisterType((*PoolBalances)(nil), "fury.liquidity.v1beta1.PoolBalances")
	proto.RegisterType((*OrderBookPairResponse)(nil), "fury.liquidity.v1beta1.OrderBookPairResponse")
	proto.RegisterType((*OrderBookResponse)(nil), "fury.liquidity.v1beta1.OrderBookResponse")
	proto.RegisterType((*OrderBookTickResponse)(nil), "fury.liquidity.v1beta1.OrderBookTickResponse")
}

func init() {
	proto.RegisterFile("fury/liquidity/v1beta1/query.proto", fileDescriptor_8e63b16e9937d1f1)
}
...
func (c *queryClient) OrderBooks(ctx context.Context, in *QueryOrderBooksRequest, opts ...grpc.CallOption) (*QueryOrderBooksResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.liquidity.v1beta1.Query/OrderBooks", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_OrderBooks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.liquidity.v1beta1.Query/OrderBooks",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
