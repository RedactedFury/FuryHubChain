...
func init() {
	...
	proto.RegisterType((*MsgCreateRangedPool)(nil), "fury.liquidity.v1beta1.MsgCreateRangedPool")
	proto.RegisterType((*MsgCreateRangedPoolResponse)(nil), "fury.liquidity.v1beta1.MsgCreateRangedPoolResponse")
	...
	proto.RegisterType((*MsgMMOrder)(nil), "fury.liquidity.v1beta1.MsgMMOrder")
	proto.RegisterType((*MsgMMOrderResponse)(nil), "fury.liquidity.v1beta1.MsgMMOrderResponse")
	...
	proto.RegisterType((*MsgCancelMMOrder)(nil), "fury.liquidity.v1beta1.MsgCancelMMOrder")
	proto.RegisterType((*MsgCancelMMOrderResponse)(nil), "fury.liquidity.v1beta1.MsgCancelMMOrderResponse")
}

func init() {
	proto.RegisterFile("fury/liquidity/v1beta1/tx.proto", fileDescriptor_3375f519d86c7b7b)
}
...
func (c *msgClient) CreateRangedPool(ctx context.Context, in *MsgCreateRangedPool, opts ...grpc.CallOption) (*MsgCreateRangedPoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.liquidity.v1beta1.Msg/CreateRangedPool", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) MMOrder(ctx context.Context, in *MsgMMOrder, opts ...grpc.CallOption) (*MsgMMOrderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.liquidity.v1beta1.Msg/MMOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CancelMMOrder(ctx context.Context, in *MsgCancelMMOrder, opts ...grpc.CallOption) (*MsgCancelMMOrderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.liquidity.v1beta1.Msg/CancelMMOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateRangedPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.liquidity.v1beta1.Msg/CreateRangedPool",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_MMOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.liquidity.v1beta1.Msg/MMOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_CancelMMOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.liquidity.v1beta1.Msg/CancelMMOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
