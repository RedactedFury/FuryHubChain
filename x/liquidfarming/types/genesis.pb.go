...
// source: fury/liquidfarming/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "fury.liquidfarming.v1beta1.GenesisState")
	proto.RegisterType((*LastRewardsAuctionIdRecord)(nil), "fury.liquidfarming.v1beta1.LastRewardsAuctionIdRecord")
	proto.RegisterType((*WinningBidRecord)(nil), "fury.liquidfarming.v1beta1.WinningBidRecord")
}

func init() {
	proto.RegisterFile("fury/liquidfarming/v1beta1/genesis.proto", fileDescriptor_44424f8d1eeb4fef)
}
