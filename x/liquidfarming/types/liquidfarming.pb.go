...
// source: fury/liquidfarming/v1beta1/liquidfarming.proto
...
type RewardsAuction struct {
	...
	Status AuctionStatus `protobuf:"varint,7,opt,name=status,proto3,enum=fury.liquidfarming.v1beta1.AuctionStatus" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum("fury.liquidfarming.v1beta1.AuctionStatus", AuctionStatus_name, AuctionStatus_value)
	proto.RegisterType((*RewardsAuction)(nil), "fury.liquidfarming.v1beta1.RewardsAuction")
	proto.RegisterType((*CompoundingRewards)(nil), "fury.liquidfarming.v1beta1.CompoundingRewards")
	proto.RegisterType((*Bid)(nil), "fury.liquidfarming.v1beta1.Bid")
}

func init() {
	proto.RegisterFile("fury/liquidfarming/v1beta1/liquidfarming.proto", fileDescriptor_c85a706fbdcf4344)
}
