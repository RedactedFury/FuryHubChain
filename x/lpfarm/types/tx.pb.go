...
// source: fury/lpfarm/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreatePrivatePlan)(nil), "fury.lpfarm.v1beta1.MsgCreatePrivatePlan")
	proto.RegisterType((*MsgCreatePrivatePlanResponse)(nil), "fury.lpfarm.v1beta1.MsgCreatePrivatePlanResponse")
	proto.RegisterType((*MsgFarm)(nil), "fury.lpfarm.v1beta1.MsgFarm")
	proto.RegisterType((*MsgFarmResponse)(nil), "fury.lpfarm.v1beta1.MsgFarmResponse")
	proto.RegisterType((*MsgUnfarm)(nil), "fury.lpfarm.v1beta1.MsgUnfarm")
	proto.RegisterType((*MsgUnfarmResponse)(nil), "fury.lpfarm.v1beta1.MsgUnfarmResponse")
	proto.RegisterType((*MsgHarvest)(nil), "fury.lpfarm.v1beta1.MsgHarvest")
	proto.RegisterType((*MsgHarvestResponse)(nil), "fury.lpfarm.v1beta1.MsgHarvestResponse")
}

func init() { proto.RegisterFile("fury/lpfarm/v1beta1/tx.proto", fileDescriptor_cf380b18e59baef2) }
...
func (c *msgClient) CreatePrivatePlan(ctx context.Context, in *MsgCreatePrivatePlan, opts ...grpc.CallOption) (*MsgCreatePrivatePlanResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.lpfarm.v1beta1.Msg/CreatePrivatePlan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Farm(ctx context.Context, in *MsgFarm, opts ...grpc.CallOption) (*MsgFarmResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.lpfarm.v1beta1.Msg/Farm", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Unfarm(ctx context.Context, in *MsgUnfarm, opts ...grpc.CallOption) (*MsgUnfarmResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.lpfarm.v1beta1.Msg/Unfarm", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Harvest(ctx context.Context, in *MsgHarvest, opts ...grpc.CallOption) (*MsgHarvestResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.lpfarm.v1beta1.Msg/Harvest", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePrivatePlan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.lpfarm.v1beta1.Msg/CreatePrivatePlan",
	}
...
func _Msg_Farm_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.lpfarm.v1beta1.Msg/Farm",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_Unfarm_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.lpfarm.v1beta1.Msg/Unfarm",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_Harvest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.lpfarm.v1beta1.Msg/Harvest",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "fury.lpfarm.v1beta1.Msg",
	...
	Metadata: "fury/lpfarm/v1beta1/tx.proto",
}
