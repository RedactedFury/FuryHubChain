...
// source: fury/lpfarm/v1beta1/proposal.proto
...
func init() {
	proto.RegisterType((*FarmingPlanProposal)(nil), "fury.lpfarm.v1beta1.FarmingPlanProposal")
	proto.RegisterType((*CreatePlanRequest)(nil), "fury.lpfarm.v1beta1.CreatePlanRequest")
	proto.RegisterType((*TerminatePlanRequest)(nil), "fury.lpfarm.v1beta1.TerminatePlanRequest")
}

func init() {
	proto.RegisterFile("fury/lpfarm/v1beta1/proposal.proto", fileDescriptor_f08a1ded86706e2d)
}
