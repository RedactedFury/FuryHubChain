...
// source: fury/claim/v1beta1/claim.proto
...
type Airdrop struct {
	...
	Conditions []ConditionType `protobuf:"varint,3,rep,packed,name=conditions,proto3,enum=fury.claim.v1beta1.ConditionType" json:"conditions,omitempty"`
...
type ClaimRecord struct {
	...
	ClaimedConditions []ConditionType `protobuf:"varint,5,rep,packed,name=claimed_conditions,json=claimedConditions,proto3,enum=fury.claim.v1beta1.ConditionType" json:"claimed_conditions,omitempty"`
}
...
func init() {
	proto.RegisterEnum("fury.claim.v1beta1.ConditionType", ConditionType_name, ConditionType_value)
	proto.RegisterType((*Airdrop)(nil), "fury.claim.v1beta1.Airdrop")
	proto.RegisterType((*ClaimRecord)(nil), "fury.claim.v1beta1.ClaimRecord")
}

func init() {
	proto.RegisterFile("fury/claim/v1beta1/claim.proto", fileDescriptor_2502de86f40cec83)
}
