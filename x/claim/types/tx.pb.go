...
// source: fury/claim/v1beta1/tx.proto
...
type MsgClaim struct {
	...
	ConditionType ConditionType `protobuf:"varint,3,opt,name=condition_type,json=conditionType,proto3,enum=fury.claim.v1beta1.ConditionType" json:"condition_type,omitempty"`
}
...
func init() {
	proto.RegisterType((*MsgClaim)(nil), "fury.claim.v1beta1.MsgClaim")
	proto.RegisterType((*MsgClaimResponse)(nil), "fury.claim.v1beta1.MsgClaimResponse")
}

func init() { proto.RegisterFile("fury/claim/v1beta1/tx.proto", fileDescriptor_fcf8d68258dc7e31) }
...
func (c *msgClient) Claim(ctx context.Context, in *MsgClaim, opts ...grpc.CallOption) (*MsgClaimResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.claim.v1beta1.Msg/Claim", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Claim_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.claim.v1beta1.Msg/Claim",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "fury.claim.v1beta1.Msg",
	...
	Metadata: "fury/claim/v1beta1/tx.proto",
}
