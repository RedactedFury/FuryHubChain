...
// source: fury/liquidstaking/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "fury.liquidstaking.v1beta1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "fury.liquidstaking.v1beta1.QueryParamsResponse")
	proto.RegisterType((*QueryLiquidValidatorsRequest)(nil), "fury.liquidstaking.v1beta1.QueryLiquidValidatorsRequest")
	proto.RegisterType((*QueryLiquidValidatorsResponse)(nil), "fury.liquidstaking.v1beta1.QueryLiquidValidatorsResponse")
	proto.RegisterType((*QueryStatesRequest)(nil), "fury.liquidstaking.v1beta1.QueryStatesRequest")
	proto.RegisterType((*QueryStatesResponse)(nil), "fury.liquidstaking.v1beta1.QueryStatesResponse")
	proto.RegisterType((*QueryVotingPowerRequest)(nil), "fury.liquidstaking.v1beta1.QueryVotingPowerRequest")
	proto.RegisterType((*QueryVotingPowerResponse)(nil), "fury.liquidstaking.v1beta1.QueryVotingPowerResponse")
}

func init() {
	proto.RegisterFile("fury/liquidstaking/v1beta1/query.proto", fileDescriptor_a37bd8b89a8d11ee)
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.liquidstaking.v1beta1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) LiquidValidators(ctx context.Context, in *QueryLiquidValidatorsRequest, opts ...grpc.CallOption) (*QueryLiquidValidatorsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.liquidstaking.v1beta1.Query/LiquidValidators", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) VotingPower(ctx context.Context, in *QueryVotingPowerRequest, opts ...grpc.CallOption) (*QueryVotingPowerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.liquidstaking.v1beta1.Query/VotingPower", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) States(ctx context.Context, in *QueryStatesRequest, opts ...grpc.CallOption) (*QueryStatesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.liquidstaking.v1beta1.Query/States", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.liquidstaking.v1beta1.Query/Params",
	}
...
func _Query_LiquidValidators_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.liquidstaking.v1beta1.Query/LiquidValidators",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_VotingPower_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.liquidstaking.v1beta1.Query/VotingPower",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_States_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.liquidstaking.v1beta1.Query/States",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "fury.liquidstaking.v1beta1.Query",
	...
	Metadata: "fury/liquidstaking/v1beta1/query.proto",
}
