...
// source: fury/liquidstaking/v1beta1/liquidstaking.proto
...
type LiquidValidatorState struct {
	...
	Status ValidatorStatus `protobuf:"varint,3,opt,name=status,proto3,enum=fury.liquidstaking.v1beta1.ValidatorStatus" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum("fury.liquidstaking.v1beta1.ValidatorStatus", ValidatorStatus_name, ValidatorStatus_value)
	proto.RegisterType((*Params)(nil), "fury.liquidstaking.v1beta1.Params")
	proto.RegisterType((*WhitelistedValidator)(nil), "fury.liquidstaking.v1beta1.WhitelistedValidator")
	proto.RegisterType((*LiquidValidator)(nil), "fury.liquidstaking.v1beta1.LiquidValidator")
	proto.RegisterType((*LiquidValidatorState)(nil), "fury.liquidstaking.v1beta1.LiquidValidatorState")
	proto.RegisterType((*NetAmountState)(nil), "fury.liquidstaking.v1beta1.NetAmountState")
	proto.RegisterType((*VotingPower)(nil), "fury.liquidstaking.v1beta1.VotingPower")
}

func init() {
	proto.RegisterFile("fury/liquidstaking/v1beta1/liquidstaking.proto", fileDescriptor_f11ef7f6d0889fb0)
}
