...
// source: fury/marketmaker/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "fury.marketmaker.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("fury/marketmaker/v1beta1/genesis.proto", fileDescriptor_15caac8a2480ca91)
}
