...
// source: fury/marketmaker/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgApplyMarketMaker)(nil), "fury.marketmaker.v1beta1.MsgApplyMarketMaker")
	proto.RegisterType((*MsgApplyMarketMakerResponse)(nil), "fury.marketmaker.v1beta1.MsgApplyMarketMakerResponse")
	proto.RegisterType((*MsgClaimIncentives)(nil), "fury.marketmaker.v1beta1.MsgClaimIncentives")
	proto.RegisterType((*MsgClaimIncentivesResponse)(nil), "fury.marketmaker.v1beta1.MsgClaimIncentivesResponse")
}

func init() {
	proto.RegisterFile("fury/marketmaker/v1beta1/tx.proto", fileDescriptor_e4975fca4e8c6083)
}
...
func (c *msgClient) ApplyMarketMaker(ctx context.Context, in *MsgApplyMarketMaker, opts ...grpc.CallOption) (*MsgApplyMarketMakerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.marketmaker.v1beta1.Msg/ApplyMarketMaker", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ClaimIncentives(ctx context.Context, in *MsgClaimIncentives, opts ...grpc.CallOption) (*MsgClaimIncentivesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.marketmaker.v1beta1.Msg/ClaimIncentives", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_ApplyMarketMaker_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.marketmaker.v1beta1.Msg/ApplyMarketMaker",
	}
...
func _Msg_ClaimIncentives_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.marketmaker.v1beta1.Msg/ClaimIncentives",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "fury.marketmaker.v1beta1.Msg",
	...
	Metadata: "fury/marketmaker/v1beta1/tx.proto",
}
