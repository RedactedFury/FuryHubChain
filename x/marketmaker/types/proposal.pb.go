...
// source: fury/marketmaker/v1beta1/proposal.proto
...
func init() {
	proto.RegisterType((*MarketMakerProposal)(nil), "fury.marketmaker.v1beta1.MarketMakerProposal")
	proto.RegisterType((*MarketMakerHandle)(nil), "fury.marketmaker.v1beta1.MarketMakerHandle")
	proto.RegisterType((*IncentiveDistribution)(nil), "fury.marketmaker.v1beta1.IncentiveDistribution")
}

func init() {
	proto.RegisterFile("fury/marketmaker/v1beta1/proposal.proto", fileDescriptor_762a5d4b14c9db68)
}
