...
The `MsgAdvanceEpoch` message is for testing purposes only and requires that you build the `furyd` binary. See [MsgAdvanceEpoch](04_messages.md#MsgAdvanceEpoch).
